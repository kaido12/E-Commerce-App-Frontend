...
const Contact = () => {
  return (
    <>
      ...
      <Container classlabel="contact-wrapper py-5 px-5 home-wrapper-3">
        <div className="row">
                  ...
                  <ul className="ps-0 list-unstyled">
                    <li className="mb-3 contact-li d-flex gap-15 align-items-center">
                      ...
                      <address className="mb-0 ">
                        T-62, Bandhan Palace, Jampur, Noida, 110162
                      </address>
                    </li>
                    <li className="mb-3 contact-li d-flex gap-15 align-items-center">
                      <IoMailOutline className="fs-5" />
                      <a href="mail to: jirachi@hotmail.com">
                        jirachi@hotmail.com
                      </a>
                    </li>
                    <li className="mb-3 contact-li d-flex gap-15 align-items-center">
                      <IoCallOutline className="fs-5" />
                      <a href="tel: +91-8081828384">+91-8081828384</a>
                    </li>
                    <li className="mb-3 contact-li d-flex gap-15 align-items-center">
